...
public class FolderView extends SpringboardView {
    ...
    private   onEditingChangeListener editingChangeListener;
...
//            showDropAnimation(x, y);
    ...
    public interface  onEditingChangeListener{
        void onChange(boolean isEditing);
    }


    public onEditingChangeListener getEditingChangeListener() {
        return editingChangeListener;
    }

    public void setEditingChangeListener(onEditingChangeListener editingChangeListener) {
